...
class LoginByFacebookType extends AbstractType
{
    /**
     * {@inheritdoc}
     */
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        ->add('facebookId',TextType::class,array('label_attr'=>array('class'=>'control-label'),'attr'=>array('class'=>'form-control','placeholder'=>'form.email')))
    ...
    {
        return 'apachecms_backendbundle_customer_login_by_facebook';
    }
